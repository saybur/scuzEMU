...
data 'DITL' (256, "Generic") {
	$"0001 0000 0000 0037 010D 004B 0147 0402"            /* .......7.¬.K.G.. */
	$"4F4B 0000 0000 000A 004E 002A 0147 8802"            /* OK.......N.*.Gà. */
	$"5E30"                                               /* ^0 */
};
...
data 'DITL' (258, "SCSI Error") {
	$"0001 0000 0000 0057 010D 006B 0147 0402"            /* .......W.¬.k.G.. */
	$"4F4B 0000 0000 000A 004E 004A 0147 8807"            /* OK.......N.J.Gà. */
	$"5E30 2028 5E31 294B"                                /* ^0 (^1)K */
};
...
data 'DITL' (260, "Memory Error") {
	$"0001 0000 0000 0047 010D 005B 0147 0402"            /* .......G.¬.[.G.. */
	$"4F4B 0000 0000 000A 004E 003A 0147 8861"            /* OK.......N.:.Gàa */
...
data 'ALRT' (256, "Generic") {
	$"0028 0028 007D 017C 0100 5555"                      /* .(.(.}.|..UU */
};

data 'ALRT' (258, "SCSI Error") {
	$"0028 0028 009D 017C 0102 5555"                      /* .(.(.ù.|..UU */
};

data 'ALRT' (259, "File Error") {
	$"0028 0028 009D 017C 0103 5555"                      /* .(.(.ù.|..UU */
};

data 'ALRT' (260, "Memory Error") {
	$"0028 0028 008D 017C 0104 5555"                      /* .(.(.ç.|..UU */
};
...
data 'STR#' (256, "Generic Alerts") {
	$"0002 204E 6F20 6669 6C65 206D 6174 6368"            /* .. No file match */
	...
	$"6167 6520 6C69 7374 2E"                             /* age list. */
};

data 'STR#' (128, "General") {
...
data 'scuz' (0, "Owner resource") {
	$"0B73 6375 7A45 4D55 2030 2E31"                      /* .scuzEMU 0.1 */
};

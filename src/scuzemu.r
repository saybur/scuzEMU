data 'MENU' (129, "File") {
	$"0081 0000 0000 0000 0000 FFFF FF83 0446"            /* .Å...........É.F */
	$"696C 6507 4F70 656E 2E2E 2E00 4F00 0001"            /* ile.Open....O... */
	$"2D00 0000 0009 5570 6C6F 6164 2E2E 2E00"            /* -....ΔUpload.... */
	$"5500 0001 2D00 0000 000C 4469 7265 6374"            /* U...-.....Direct */
	$"6F72 792E 2E2E 0044 0000 012D 0000 0000"            /* ory....D...-.... */
...
data 'MENU' (257, "SCSI IDs") {
	$"0101 0000 0000 0000 0000 FFFF FFFF 0554"            /* ...............T */
	$"6974 6C65 0953 4353 4920 4944 2030 0000"            /* itleΔSCSI ID 0.. */
	$"0000 0953 4353 4920 4944 2031 0000 0000"            /* ..ΔSCSI ID 1.... */
	$"0953 4353 4920 4944 2032 0000 0000 0953"            /* ΔSCSI ID 2....ΔS */
	$"4353 4920 4944 2033 0000 0000 0953 4353"            /* CSI ID 3....ΔSCS */
	$"4920 4944 2034 0000 0000 0953 4353 4920"            /* I ID 4....ΔSCSI  */
	$"4944 2035 0000 0000 0953 4353 4920 4944"            /* ID 5....ΔSCSI ID */
	$"2036 0000 0000 00"                                  /*  6..... */
};

data 'MENU' (256, "SCSI Bus Default") {
	$"0100 0000 0000 0000 0000 FFFF FFFF 0554"            /* ...............T */
	$"6974 6C65 0744 6566 6175 6C74 0000 0000"            /* itle.Default.... */
	$"00"                                                 /* . */
};
...
data 'DITL' (514, "Choose Work Directory") {
	$"0004 0000 0000 004D 010A 0061 0146 0402"            /* .......M...a.F.. */
	$"4F4B 0000 0000 004D 00C1 0061 00FD 0406"            /* OK.....M.¡.a.... */
	$"4361 6E63 656C 0000 0000 000A 0012 001A"            /* Cancel.......... */
	$"00B4 8818 5365 7420 576F 726B 696E 6720"            /* .¥à.Set Working  */
	$"4469 7265 6374 6F72 792E 2E2E 0000 0000"            /* Directory....... */
	$"0045 0102 0069 014E 8000 0000 0000 0027"            /* .E...i.NÄ......' */
	$"0012 0037 013C 1000"                                /* ...7.<.. */
};
...
data 'DITL' (513, "Choose ID (System 7)") {
	$"0009 0000 0000 00B2 00AA 00C6 00E6 0402"            /* .Δ.....≤.™.Δ.... */
	$"4F4B 0000 0000 00B2 0061 00C6 009D 0406"            /* OK.....≤.a.Δ.ù.. */
	$"4361 6E63 656C 0000 0000 0027 0014 0037"            /* Cancel.....'...7 */
	$"0078 0702 0100 0000 0000 0042 0014 0052"            /* .x.........B...R */
	$"00DC 0702 0101 0000 0000 008D 0014 009D"            /* ...........ç...ù */
	$"0064 0605 4669 6C65 7300 0000 0000 008D"            /* .d..Files......ç */
	$"008C 009D 00DC 0606 496D 6167 6573 0000"            /* .å.ù....Images.. */
	$"0000 000A 0014 001A 00AA 8815 4F70 656E"            /* .........™à.Open */
	$"2053 4353 4920 456D 756C 6174 6F72 2E2E"            /*  SCSI Emulator.. */
	$"2E00 0000 0000 0073 0014 0083 0078 880E"            /* .......s...É.xà. */
	$"4765 7420 4C69 7374 206F 662E 2E2E 0000"            /* Get List of..... */
	$"0000 0065 0014 0066 00DC 8000 0000 0000"            /* ...e...f..Ä..... */
	$"00AA 00A2 00CE 00EE 8000"                           /* .™.¢.Œ..Ä. */
};
...
data 'DLOG' (512, "Choose ID") {
	$"0028 0014 0122 0103 0001 0000 0000 0000"            /* .(...".......... */
	$"0000 0200 1253 656C 6563 7420 456D 756C"            /* .....Select Emul */
	$"6174 6F72 2049 44"                                  /* ator ID */
};

data 'DLOG' (514, "Choose Work Directory") {
	$"0028 0014 012B 0110 0001 0000 0000 0000"            /* .(...+.......... */
	$"0000 0201 1553 6574 2057 6F72 6B69 6E67"            /* .....Set Working */
	$"2044 6972 6563 746F 7279"                           /*  Directory */
};

data 'DLOG' (513, "Choose ID (System 7)") {
	$"0028 0014 00F8 0103 0001 0000 0000 0000"            /* .(.............. */
	$"0000 0201 1253 656C 6563 7420 456D 756C"            /* .....Select Emul */
	$"6174 6F72 2049 44"                                  /* ator ID */
};
...
data 'scuz' (0, "Owner resource") {
	$"0B73 6375 7A45 4D55 2064 6576"                      /* .scuzEMU dev */
};
...
data 'CNTL' (256, "SCSI Bus Pop-Up") {
	$"0027 0014 003A 00DC 0000 0100 002C 0100"            /* .'...:.......,.. */
	$"03F1 0000 0000 0442 7573 3A"                        /* .......Bus: */
};

data 'CNTL' (257, "SCSI ID Pop-Up") {
	$"0042 0014 0055 00DC 0000 0100 002C 0101"            /* .B...U.......,.. */
	$"03F1 0000 0000 0349 443A"                           /* .......ID: */
};

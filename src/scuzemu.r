...
data 'DITL' (133, "Image No Device") {
	$"0002 0000 0000 0074 00FC 0088 0136 0402"            /* .......t...à.6.. */
	$"4F4B 0000 0000 000A 0054 002A 0136 883A"            /* OK.......T.*.6à: */
	$"436F 756C 6420 6E6F 7420 6669 6E64 2061"            /* Could not find a */
	$"6E20 6F70 6572 6174 696E 6720 7379 7374"            /* n operating syst */
	$"656D 2064 7269 7665 7220 666F 7220 7468"            /* em driver for th */
	$"6973 2064 6576 6963 652E 0000 0000 003A"            /* is device......: */
	$"0054 006A 0136 884A 4368 6563 6B20 796F"            /* .T.j.6àJCheck yo */
	$"7572 2065 7874 656E 7369 6F6E 7320 616E"            /* ur extensions an */
	$"6420 7665 7269 6679 2074 6865 2065 6D75"            /* d verify the emu */
	$"6C61 746F 7220 6973 2062 6569 6E67 2073"            /* lator is being s */
	$"6565 6E20 6279 2074 6865 2073 7973 7465"            /* een by the syste */
	$"6D2E"                                               /* m. */
};

data 'DITL' (134, "Image Change Busy") {
	$"0001 0000 0000 0044 00FC 0058 0136 0402"            /* .......D...X.6.. */
	$"4F4B 0000 0000 000A 0054 003A 0136 8844"            /* OK.......T.:.6àD */
	$"5468 6572 6520 6172 6520 6669 6C65 7320"            /* There are files  */
	$"6F70 656E 206F 6E20 7468 6520 6375 7272"            /* open on the curr */
	$"656E 7420 696D 6167 652E 2043 6C6F 7365"            /* ent image. Close */
	$"2074 6865 6D20 616E 6420 7472 7920 6167"            /*  them and try ag */
	$"6169 6E2E"                                          /* ain. */
};

data 'DITL' (135, "Image Unmount Error") {
	$"0001 0000 0000 0036 00FC 004A 0136 0402"            /* .......6...J.6.. */
	$"4F4B 0000 0000 000A 0054 002A 0136 8829"            /* OK.......T.*.6à) */
	$"436F 756C 6420 6E6F 7420 756E 6D6F 756E"            /* Could not unmoun */
	$"7420 7468 6520 6375 7272 656E 7420 696D"            /* t the current im */
	$"6167 652E 2028 5E30 2900"                           /* age. (^0). */
};

data 'DITL' (136, "Image Eject Error") {
	$"0001 0000 0000 0054 00FC 0068 0136 0402"            /* .......T...h.6.. */
	$"4F4B 0000 0000 000A 0054 003A 0136 8862"            /* OK.......T.:.6àb */
	$"4465 7669 6365 2064 7269 7665 7220 7265"            /* Device driver re */
	$"706F 7274 6564 2061 6E20 6572 726F 7220"            /* ported an error  */
	$"6475 7269 6E67 2065 6A65 6374 696F 6E2E"            /* during ejection. */
	$"2054 7279 2064 7261 6767 696E 6720 7468"            /*  Try dragging th */
	$"6520 696D 6167 6520 746F 2074 6865 2054"            /* e image to the T */
	$"7261 7368 2069 6E73 7465 6164 2E20 285E"            /* rash instead. (^ */
	$"3029"                                               /* 0) */
};
...
data 'ALRT' (133, "Image No Device") {
	$"0028 0028 00BA 016D 0085 5555"                      /* .(.(.∫.m.ÖUU */
};

data 'ALRT' (134, "Image Change Busy") {
	$"0028 0028 008A 0168 0086 5555"                      /* .(.(.ä.h.ÜUU */
};

data 'ALRT' (135, "Image Unmount Error") {
	$"0028 0028 007C 0168 0087 5555"                      /* .(.(.|.h.áUU */
};

data 'ALRT' (136, "Image Eject Error") {
	$"0028 0028 009A 0168 0088 5555"                      /* .(.(.ö.h.àUU */
};
